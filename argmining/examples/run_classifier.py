        ...
        with open(input_file, "r") as f:
            ...
            for line in reader:
                if sys.version_info[0] == 2:
                    ...
                    line = list(cell.decode(encoding='UTF-8') for cell in line)
                lines.append(line)
            return lines
...
class ArgProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        logger.info("LOOKING AT {}".format(os.path.join(data_dir, "train_everything.tsv")))
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train_everything.tsv")), "train")
